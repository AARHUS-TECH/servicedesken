                ...
                <div class="row">
                    <div class="card border-success col-md-12">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form method="POST" action="/elev/tickets/opdaterSag.php">
                                        <fieldset>
                                            ...
                                            <div class="form-group form-row">    
                                                ...
                                                <div class="col">
                                                    <a class="btn btn-outline-info full-width" rel="noopener noreferrer" target="_blank" href="/elev/tickets/print/indlevering.php?ticketID=<?php echo Input::get('id'); ?>">Service Seddel (Indlevering)</a>
                                                </div>
                                                <div class="col">
                                                    <a class="btn btn-outline-info full-width" rel="noopener noreferrer" target="_blank" href="/elev/tickets/print/afhent.php?ticketID=<?php echo Input::get('id'); ?>">Service Seddel (Afhentning)</a>
                                                </div>
                                            </div>
